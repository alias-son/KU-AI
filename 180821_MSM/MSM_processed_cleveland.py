...
#cn = len(np.unique(list(zip(*data))[1]))
...
pl=[]     # Put p in sequence
rsl = []
itera = 1
oldfuzzy = []

# Coding to find a random number whose p value is greater than 0.5 <- using random seed
while itera > 0:
    p = [0]*l
